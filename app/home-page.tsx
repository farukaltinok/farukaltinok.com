...
export default function Home() {
  ...
  const lines =
    lang === "de"
      ? [
          "Ich baue Personal Brands & Apps.",
          `Ich bin ${age} y/o türkisch-deutscher Creator, geboren in Köln.`,
          ...
          "Du erreichst mich per E-Mail unter kontakt@farukaltinok.com",
          "LG Faruk",
        ]
      : [
          "I build personal brands & apps.",
          `I'm a ${age} y/o Turkish-German creator, born in Cologne.`,
          ...
          "You can reach me via email at kontakt@farukaltinok.com",
          "Best, Faruk",
        ];
